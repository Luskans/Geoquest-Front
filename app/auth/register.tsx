...
//       <View className="flex-col justify-center h-full gap-10">
...
//           {/* Username Input */}
//           <View>
//             <Text className="text-gray-700 mb-2">Nom d'utilisateur</Text>
//             <TextInput
...
//           <View>
//             <Text className="text-gray-700 mb-2">Confirmer le mot de passe</Text>
//             <TextInput
//               className={`bg-gray-50 border ${
...
//                 acceptedTerms ? 'bg-primary-600 border-primary-600' : 'border-gray-300'
  ...
  return (
    ...
    >
      <ParallaxScrollView
        ...
        headerText="Inscris toi et crée ta partie !"
      >
